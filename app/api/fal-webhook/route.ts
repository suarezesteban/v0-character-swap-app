...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`[fal-webhook] [${new Date().toISOString()}] Received callback for generation ${generationId}`)
    ...
    console.log(`[fal-webhook] [${new Date().toISOString()}] Body:`, JSON.stringify(body, null, 2))
