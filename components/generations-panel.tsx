        ...
        {generations.filter(g => g.status !== "cancelled").map((gen) => (
          ...
          >
            ...
            {gen.status === "completed" && gen.video_url ? (
              ...
              <div className="group relative flex h-full w-full flex-col items-center justify-center gap-1">
                {gen.character_image_url ? (
                  <Image
                    src={gen.character_image_url || "/placeholder.svg"}
                    alt=""
                    fill
                ...
                <div className="relative z-10 flex flex-col items-center gap-1">
                  ...
                  <span className="font-mono text-[8px] text-neutral-400">
                    {gen.status === "uploading" ? "Uploading" : gen.status === "pending" ? "Queued" : "Generating"}
                  </span>
                </div>
